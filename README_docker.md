...
**基础版**镜像：`docker.io/admpub/nging:latest`  (Docker主页：https://hub.docker.com/r/admpub/nging)  或者 `ghcr.io/admpub/nging:latest`  
**先锋版**镜像：`docker.io/admpub/nging-dockermgr:latest`  (Docker主页：https://hub.docker.com/r/admpub/nging-dockermgr) 或者 `ghcr.io/admpub/nging-dockermgr:latest`  
